      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div className="w-full lg:w-1/2 animate-slide-right">
          <div className="relative">
            ...
            <img src="/images/reception-hero.jpg" alt="Reception agents" className="relative rounded-3xl shadow-2xl w-full object-cover hero-image-zoom" style={{maxHeight:'550px', objectFit:'cover'}}/>
