...
function CTAButtons({ slug }: { slug: string }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 mb-6">
      <Link href={`/fr/contact?service=${slug}`} className="bg-blue-600 text-white font-bold px-7 py-3.5 rounded-xl hover:bg-blue-700 text-center shadow-lg">
        Démo Sans Engagement
      </Link>
      {showPhone ? (
        <a href={`tel:${CONTACT.phone}`} className="border-2 border-blue-600 text-blue-600 font-bold px-7 py-3.5 rounded-xl hover:bg-blue-600 hover:text-white transition-all text-center">
          {CONTACT.phoneDisplay}
        </a>
      ) : (
        <a href={CONTACT.whatsapp} target="_blank" rel="noopener noreferrer" className="border-2 border-blue-600 text-blue-600 font-bold px-7 py-3.5 rounded-xl hover:bg-blue-600 hover:text-white transition-all text-center">
          💬 WhatsApp 24/7
        </a>
      )}
    </div>
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-blue-900 text-white py-20 lg:py-24 overflow-hidden relative">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -top-32 -right-32 w-[500px] h-[500px] bg-blue-500 opacity-10 rounded-full blur-3xl"></div>
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-black mb-4">Ce qui est inclus</h2>
            <p className="text-blue-200 text-lg max-w-2xl mx-auto">Tout ce qu\'il faut pour ne plus jamais rater un appel important.</p>
          </div>
      ...
      <section className="bg-white border-b border-slate-100 py-10">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          <div><p className="text-4xl font-black text-blue-600">99.2%</p><p className="text-slate-500 text-sm mt-1">Taux de réponse</p></div>
          <div><p className="text-4xl font-black text-blue-600">2.8s</p><p className="text-slate-500 text-sm mt-1">Temps de réponse</p></div>
          <div><p className="text-4xl font-black text-blue-600">150+</p><p className="text-slate-500 text-sm mt-1">Entreprises servies</p></div>
          <div><p className="text-4xl font-black text-blue-600">24/7</p><p className="text-slate-500 text-sm mt-1">Disponibilité</p></div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl font-black shadow-lg">1</div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl font-black shadow-lg">2</div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl font-black shadow-lg">3</div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl font-black shadow-lg">4</div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-14">
            <div className="w-full lg:w-[55%]">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3 text-slate-700"><span className="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center"><CheckIcon className="w-4 h-4"/></span>Conseillers francophones du Québec et de France</li>
                <li className="flex items-center gap-3 text-slate-700"><span className="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center"><CheckIcon className="w-4 h-4"/></span>Messages transmis par SMS, email, ou appel</li>
                <li className="flex items-center gap-3 text-slate-700"><span className="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center"><CheckIcon className="w-4 h-4"/></span>Prix PME — 40-60% moins cher qu\'un employé</li>
                <li className="flex items-center gap-3 text-slate-700"><span className="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center"><CheckIcon className="w-4 h-4"/></span>Annulez quand vous voulez — pas de contrat long</li>
              </ul>
              <Link href="/fr/contact?service=reception" className="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3.5 rounded-xl font-bold hover:bg-blue-700 transition-colors">
                Voir une démo →
              </Link>
            </div>
            <div className="w-full lg:w-[40%]">
              <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100">
                ...
                <p className="text-3xl font-black text-blue-600 mb-2">À partir de 15$/h</p>
                <p className="text-slate-600 mb-4">Comparé à un employé à 25-30$/h + avantages sociaux + formation.</p>
                <Link href="/fr/tarifs" className="text-blue-600 font-semibold hover:underline">Voir tous les tarifs →</Link>
              </div>
            </div>
          </div>
        </div>
            ...
            {TESTIMONIALS.map((t, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center font-bold text-white text-sm">{t.av}</div>
                  <div>
      ...
      <section className="bg-gradient-to-br from-slate-900 to-blue-800 py-20">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          <h2 className="text-3xl lg:text-4xl font-black mb-4">Prêt à ne plus rater un appel?</h2>
          <p className="text-blue-200 text-lg mb-10 max-w-2xl mx-auto">Essai gratuit de 2 semaines. Sans engagement. On commence quand vous voulez.</p>
          <CTAButtons slug="reception"/>
